...
export function ConsoleMockupSection() {
  return (
    <section className="relative max-w-7xl mx-auto px-6 py-24">
      ...
      {/* Editor mockup — mavi-dominant self-aura (chat ekranı) */}
      <div className="relative">
        <div
          ...
          style={{
            background: `
              radial-gradient(55% 60% at 25% 35%, rgba(37,99,235,0.30) 0%, transparent 65%),
              radial-gradient(50% 50% at 80% 70%, rgba(20,184,166,0.14) 0%, transparent 70%),
              radial-gradient(40% 40% at 50% 50%, rgba(15,118,110,0.08) 0%, transparent 70%)
            `,
            filter: 'blur(40px)',
          }}
        />
      <div className="relative rounded-[24px] overflow-hidden border border-outline-haze/[0.10] bg-nightfall-gray/80 backdrop-blur-xl shadow-[0_30px_120px_-20px_rgba(0,0,0,0.8),0_0_80px_-10px_rgba(37,99,235,0.22)]">
        {/* Top bar */}
